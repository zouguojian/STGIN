...
plt.plot(range(1,7,1),Bi_LSTM_mae,marker='h',color='blue',linestyle='-', linewidth=1,label='Bi_LSTM')
...
plt.plot(range(1,7,1),Bi_LSTM_rmse,marker='h',color='blue',linestyle='-', linewidth=1,label='Bi_LSTM')
...
plt.plot(range(1,7,1),Bi_LSTM_mape,marker='h',color='blue',linestyle='-', linewidth=1,label='Bi_LSTM')

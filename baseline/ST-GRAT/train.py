...
parser.add_argument('--name', type = str, default = 'METR-LA',
                    help = 'dataset name')
...
parser.add_argument('--N', type = float, default = 207,
...
parser.add_argument('--log_file', default = 'log(PEMS)',
                    help = 'log file')
parser.add_argument('--adjacent_file', default = 'data/sensor_graph/adj_mx.pkl',
                    help = 'adjacent file')

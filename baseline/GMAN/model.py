...
def placeholder(P, Q, N):
    ...
    day_of_week = tf.compat.v1.placeholder(tf.int32, shape=(None, P+Q), name='day_of_week')
    minute_of_day = tf.compat.v1.placeholder(tf.int32, shape=(None, P+Q), name='minute_of_day')
    position= tf.compat.v1.placeholder(tf.int32, shape=(1, N), name='input_position')
    return X, TE, label, is_training, day_of_week, minute_of_day, position
